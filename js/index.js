...
window.onload = function(){
	...
	$.each($(".layout-for"),function(key,val){
		if(!$(val).hasClass('layout-for-' + app.orientation)) $(val).remove();
	})
	$(".layout-for-" + app.orientation).show();
